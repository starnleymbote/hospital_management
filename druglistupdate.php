<?php
  ...
  if (empty($_SESSION['usermail']) && empty($_GET['drug_code'])) 
  {
    header('location:login.php');
  }

  else if (empty($_GET['drug_code'])) 
  {
          ...
          <div class="col-sm-2">
             ...
             <?php
                 require('connection.php');
		          ...
		          $select_drug_current_amount = "SELECT drug_amount FROM drug WHERE drug_code = '$drug_code' ";
		          $query3 = mysqli_query($connect,$select_drug_current_amount);
		          $response3 = mysqli_fetch_assoc($query3);
		          $current_amount = $response3['drug_amount'];
            ...
            <form method="POST" action="">
              <div class="login-wrapper">
                    <div class="box">
                        ...
                        <star id="star">Add Drug Amount:</star><br/><br/>
      ...
      <div class="col-sm-4">
        <?php
            ...
            if (isset($_POST['update'])) 
            {
               ...
               $amount_update = "UPDATE `drug` SET `drug_amount`= '$new_drug_amount' WHERE drug_code='$drug_code' ";
