  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <?php 
              ...
              $select = "SELECT Hospital_name FROM hospital_registration WHERE hospital_id = '$hospital_id' ";
		      	...
		      	<form method="POST" action="userauth.php">
			        <div class="login-wrapper">
			              <div class="box">
			                  ...
			                  <star id="star">Add a drug for :</star>
			                  <br/><br/>
			                    <star id="star">Hospital Name: </star><input class="form-control" type="text"  value=<?php echo $hospital_name;?> disabled ><br/><br/>
			                     <star id="star">Username: </star><input class="form-control" type="text" placeholder="Enter username" name="username" required><br/>
			                      <div class="action">
			                          <button class="btn btn-success signup" name="submit" id="userbtn">Login</button>
			                      </div>              
			                  </div>
			              </div>
			        </div>
