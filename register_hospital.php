    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="active"><a href="register_hospital.php"><i class="fa fa-edit"></i>Register Hospital</a></li>
      ...
      <div class="row">
       <div class="col-sm-4">
        ...
        <form method="POST" action="verifyier.php">
        	
        	<fieldset>
        		<h2>Register New Hospital</h2>
                     <div class="form-group">
                                           <h4> <label>Enter Hospital Id</label></h4>
                                            <input class="form-control" name="HospitalId" placeholder="Hospital Id " required="" />
                                            
                                        </div>
                                        <div class="form-group">
                                             <h4> <label>Enter Hospital Name</label></h4>
                                            <input class="form-control" name="HospitalName" placeholder="Hospital Name" required="" />
                                        </div>
                                       
                                        <div>
                                        	<strong><input type="reset" value="Reset" /></strong> 
