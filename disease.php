          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="disease.php"><i class="fa fa-plus"></i>Add Disease</a></li>
      ...
      <div class="row">
       <div class="col-sm-4">
        ...
        <form  role="form" method="POST">
        	...
        	<fieldset>
        		<h2>Register New Disease</h2>
                     <div class="form-group">
                               <h4> <label>Enter Disease Id</label></h4>
                                <input class="form-control" name="DiseaseId" placeholder="Disease Id " required="" />
                              </div>
                              <div class="form-group">
                                      <h4> <label>Enter Disease Name</label></h4>
                                      <input class="form-control" name="DiseaseName" placeholder="Disease Name" required="" />
                                </div>
                                <div>

                                <strong> <input type="submit" name="submit" value="Save " class="btn btn-success" />
                                <strong><input type="reset" value="Reset" class="btn btn-success"/></strong> 
                                        </strong> 
                                </div>
        	</fieldset>
        </form>
...
$insertion="INSERT INTO disease(disease_id,disease_name) VALUES ('$diseaseId','$diseaseName')";

	$query=mysqli_query($connect, $insertion);
	if ($query) 
	{
		echo $diseaseName."  "."was registered successfully";
	}

	else
	{
		echo ""."</br>the disease with the same name is already registered in the system";
	}
}
