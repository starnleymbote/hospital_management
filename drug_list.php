...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="drug_list.php"><i class="fa fa-user"></i>Drug List</a></li>
      ...
      <div id="page-wrapper">
      <STRONG>THE FOLLOWING IS A LIST OF DRUGS DELIVERED BY KEMSA AND AVAILABLE IN THE STOCK</STRONG>
      <hr/>
  ...
  echo "  <center><div class='table-responsive'>
        ...
        <caption><center> DRUGS LIST </center></caption>
        <thead>
        <tr>
        <th>Drug Name</th>
        <th>Drug Amount</th>
        ...
        while ($result=mysqli_fetch_array($query)) 
          {
            ...
            if ($result > 0)
            {
              ...
              <td> $result[1]</td>
              <td>$result[2]</td>
              <td><a href=druglistupdate.php?drug_code=$result[0]>Update</a></td>
              </tr>";
