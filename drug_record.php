        ...
        while ($result=mysqli_fetch_array($query)) 
          {
			...
			echo "</select>";
			echo "<input type='submit' name='submit' value='submit' id='submit_btn' class='btn btn-success'>
						</fieldset>
						</form>";
            ...
            if (isset($_POST['submit']))
            {
            	$hospital_code = $_POST['selected'];
            	 ...
            	 // $select1 = "SELECT * FROM drug_record WHERE hospital_id = '$hospital_code' ";
              ...
              <th colspan=2>DRUGS USED</th>
            	...
            	while ($findings = mysqli_fetch_array($query1))
            	 {
                    $rem = $findings[2] - $findings[1];
            		echo"  <td>$findings[5]</td>
          							<td>$findings[1]</td>
                        <td>$findings[2]</td>
                        <td>$rem</td>
          							</tr>";
